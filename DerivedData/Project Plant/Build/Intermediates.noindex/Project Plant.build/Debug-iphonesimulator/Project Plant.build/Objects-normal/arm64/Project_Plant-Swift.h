...
#ifndef PROJECT_PLANT_SWIFT_H
#define PROJECT_PLANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Project_Plant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Project_Plant11AppDelegate")
...
SWIFT_CLASS("_TtC13Project_Plant13SceneDelegate")
